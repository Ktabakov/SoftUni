using MyFirstServer.Server;
using MyFirstServer.Server.HTTP;
using MyFirstServer.Server.Responses;
using MyFirstServer.Server.Responses.ActionResponses;
using System;
   ...
   <input type='submit' value ='Log In' /> 
        ...
        public static async Task Main()
        {
            ...
            routes
                ...
                .MapGet("/UserProfile", new HtmlResponse("", StartUp.GerUserDataAction)));
        ...
        public static void GerUserDataAction(Request request, Response response)
        {
            if (request.Session.ContainsKey(Session.SessionUnserKey))
            {
                response.Body = "";
                response.Body += $"</h3>Currently logged-in user " + $"is with username {Username}"; 
            }
            else
            {
                response.Body = "";
        ...
        private static void LoginAction(Request request, Response response)
        {
            ...
            {
                request.Session[Session.SessionUnserKey] = "MyUserId";
