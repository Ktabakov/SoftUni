...
export let homeTemplate = (info) => html`<section id="home-page">
...
${info.isLoggedIn ? html`<a href="/add-movie" class="btn btn-warning ">Add Movie</a>` : ``} 
</section>
<section id="movie">
    <div class=" mt-3 ">
        <div class="row d-flex d-wrap">
            <div class="card-deck d-flex justify-content-center">
                ...
                ? info.movies.map(m => movieTemplate(m))
                : ``}
            </div>
        </div>
    </div>
...
let movieTemplate = (movie) => html`<div class="card mb-4">
